...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    * Semantic HTML is a language that both you and your browser speak.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    * ```display: block;``` forces a line break after the element, ```display: inline;``` does not. ```display: inline:``` does not allow for padding or border on the top or bottom of the element.
